...
func newJob(db *gorm.DB, opts ...gen.DOOption) job {
	...
	_job.WorkflowID = field.NewInt32(tableName, "workflow_id")
	_job.DagID = field.NewInt32(tableName, "dag_id")
	_job.TriggerID = field.NewInt32(tableName, "trigger_id")
...
type job struct {
	...
	UID        field.String
	Topic      field.String
	WorkflowID field.Int32
	DagID      field.Int32
	TriggerID  field.Int32
	State      field.Field
...
func (j *job) updateTableName(table string) *job {
	...
	j.WorkflowID = field.NewInt32(table, "workflow_id")
	j.DagID = field.NewInt32(table, "dag_id")
	j.TriggerID = field.NewInt32(table, "trigger_id")
...
func (j jobDo) GetByID(id int) (result model.Job, err error) {
	...
	generateSQL.WriteString("SELECT * FROM chatbot_jobs WHERE id=? ")
