...
func newReview(db *gorm.DB, opts ...gen.DOOption) review {
	...
	_review.ID = field.NewInt32(tableName, "id")
	_review.UID = field.NewString(tableName, "uid")
	_review.Topic = field.NewString(tableName, "topic")
	_review.ObjectiveID = field.NewInt32(tableName, "objective_id")
...
func (r *review) updateTableName(table string) *review {
	...
	r.ObjectiveID = field.NewInt32(table, "objective_id")
...
func (r reviewDo) GetByID(id int) (result model.Review, err error) {
	...
	generateSQL.WriteString("SELECT * FROM chatbot_reviews WHERE id=? ")
...
func (r reviewDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *reviewDo {
