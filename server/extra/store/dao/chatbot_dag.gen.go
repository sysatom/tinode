...
func newDag(db *gorm.DB, opts ...gen.DOOption) dag {
	...
	_dag.WorkflowID = field.NewInt32(tableName, "workflow_id")
...
func (d *dag) updateTableName(table string) *dag {
	...
	d.WorkflowID = field.NewInt32(table, "workflow_id")
...
func (d dagDo) GetByID(id int) (result model.Dag, err error) {
	...
	generateSQL.WriteString("SELECT * FROM chatbot_dag WHERE id=? ")
